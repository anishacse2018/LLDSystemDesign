...
public class CommentFilter {
    ...
    public void run() {
        ...
        List<Comment> comments = commentFilteringService.filterComments(FilterBy.TEXT, "comment", product1);
        printFilteredComments(comments);
        product1.removeCommentForProduct(comment1);
        comments = commentFilteringService.filterComments(FilterBy.POSTED, "Anisha", product1);
        printFilteredComments(comments);
    }
}
